...
function showMarkerAndInfo(lat, lng, zoom){
    ...
    //});
    marker.bindInfoWindowHtml("<div style=\"font-size:11px;height:120px;width:180px\"><a href=\"#\" onclick=\'getPhotos("+curGroup+","+curPanel+");return false;\'><img id=\"info_img\" src=\""+$curPanelImg.attr("src")+"\" width=\"150\"/><br/>点击查看相册</a></div>");
